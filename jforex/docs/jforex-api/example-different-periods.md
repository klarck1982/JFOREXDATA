Dukascopy - Indicator with inputs of different periods
...
The following example demonstrates the use of multiple periods in a single indicator. It's a simple indicator that draws lines over the close prices of three different periods: one minute, five minutes and ten minutes.
Note that the indicator will not work with periods greater than 1 minute (greater than the smallest period of indicator inputs).
