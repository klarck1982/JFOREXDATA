Dukascopy - Platform Indicator Source Files
...
-
                                                        ...
                                                        Indicators with base period

-

                                                        Platform Indicator Source Files
...
-
                                                        ...
                                                        Indicator with Predicted values
...
# Platform Indicator Source Files
                    ...
                    Platform indicator source files are available in Standalone API as well as JForex 3 platform.

There are two ways how to retrieve them:

- If you are using JForex-API in an IDE, import JForex-SDK in Eclipse, NetBeans or IntellijIDEA as described here. Then locate JForex-API:Soucres in the project libraries. Look into package com.dukascopy.indicators to find indicator source code.

- Using JForex Client, right click on the indicator in Navigator panel of JForex 3. Select "Edit". Or press "Edit" button in "Add indicator" window after indicator has been selected.

Not all of the indicator source files are available, the rest of the indicator source files can be found in ta-lib repository (also see the generated java code).

                            The information on this web site is provided only as general information, which may be incomplete or outdated. Click here for full disclaimer.

                            [image: https://www.dukascopy.com/media-storage/712573378/o/]
